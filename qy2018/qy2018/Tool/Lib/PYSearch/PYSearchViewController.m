...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //设置导航栏背景颜色
        self.navigationController.navigationBar.barTintColor = PYSEARCH_COLOR(102, 170, 106);
...
- (void)setup
{
    ...
    //设置search输入文字颜色和占位文字颜色
    searchField.textColor=[UIColor whiteColor];
     [searchField setValue:[UIColor whiteColor] forKeyPath:@"_placeholderLabel.textColor"];
    //设置搜索图片
    [searchBar setImage:[UIImage imageNamed:@"communtiy_search_icon"] forSearchBarIcon:UISearchBarIconSearch state:UIControlStateNormal];
...
- (NSArray *)addAndLayoutTagsWithTagsContentView:(UIView *)contentView tagTexts:(NSArray<NSString *> *)tagTexts;
{
    ...
    for (int i = 0; i < contentView.subviews.count; i++) {
        ...
        subView.py_width=[Helper widthOfString:subView.text font:[UIFont systemFontOfSize:14] height:30]+40;
